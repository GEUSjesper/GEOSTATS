...
% Find depth of boreholes assuming dz = 1
borehole_depth = size(d_obs,2);
...
for i=1:N
    ...
    for i_obs = 1:n_obs
        ...
        if DISTS(i_obs,i) < influence_max
            ...
            % elev_plus = ceil((ELEVATION(i)-elev_obs(i_obs))./dz)-elev_diff;
            % elev_minus = elev_diff-floor((ELEVATION(i)-elev_obs(i_obs))./dz);
