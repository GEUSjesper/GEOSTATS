function [fig_number,dist] = summary_plots4(ms,name,fig_number,d_obs,n_layers_obs,t_layers_obs,t_types_obs,tit)
...
types = {'Melt clay','Melt sand','Melt grav','Clay till','Sand till','Mio sand','Mio clay','Pal clay','Organic'};
% types = {'Me clay','Me sand','Me gravel','Clay till','Sand till','Mio sand','Mio clay','Pal clay','Organic'};
% n_types = numel(types);
n_types = 9;
[Nr,Nm] = size(ms);
...
if exist('d_obs','var')
    ...
    clim([0 1])
    title('d_{obs}','FontSize',11','FontWeight','normal')
...
nexttile(33,[3 2])
plot(E,z_vec,'-b')
set(gca,'YDir','reverse','YTick',10:10:45)
set(gca,'fontsize', 10)
